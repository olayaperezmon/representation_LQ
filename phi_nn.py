...
class PhiPequena(nn.Module):
    def __init__(self, X_shape):
        ...
        self.module.add_module("linear_2", nn.Linear(X_shape*2, X_shape//2))
...
class PhiPequena_decoder(nn.Module):
    def __init__(self, X_shape):
        ...
        self.module = torch.nn.Sequential()
        self.module.add_module("linear_1_dec", nn.Linear(X_shape//2, X_shape*2))
...
if __name__ == '__main__':
    ...
    datasets = ['academic-success'] #,'academic-success','digits','letter'] #, 'T1A'] #'dry-bean',
    ...
    for dataset_name in datasets:
        ...
        optimizer = optim.Adam(params, lr=0.1, weight_decay=0.0001)
        ...
        for age in range(n_ages):
            ...
            for epoch in range(n_epochs):
                ...
                for i, (sam, prev) in enumerate(upp_gen()):
                    ...
                    loss_reconstruction = positive_dist-negative_dist
